...
A_centered = images_to_A(show_avg_face=False, N=N,
                         img_dim=img_dim, people=people)
...
# plot in 2D
plot_projections(num_dim=2, start_ef=start_ef,
                 PER_1=PER_1, PER_2=PER_2, people=people)
plt.show()

# plot in with one more eigenface, 3D
plot_projections(num_dim=3, start_ef=start_ef,
                 PER_1=PER_1, PER_2=PER_2, people=people)
plt.show()
...
ax = plot_projections(num_dim=3, start_ef=start_ef,
                      PER_1=PER_1, PER_2=PER_2, people=people)
ax.scatter(per1_points[0], per1_points[1], per1_points[2], c='brown',
           label=people["person_1"])
ax.scatter(per2_points[0], per2_points[1], per2_points[2], c='aqua',
           label=people["person_2"])
ax.legend()
plt.show()
